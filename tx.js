...
async function main() { 
    ...
    const balances = await web3.alchemy.getTokenBalances(ownerAddr,["0x43670aD6Ca03BEE64cb21A371EDC062214825dAa"])
web3.eth.getChainId
    console.log("BALANCES->");
    console.log(balances);
    
    /*web3.eth.subscribe('logs', {
        address: '0xDbF96a30e67925B5c0A17FEb203C05bb8C985EfF',
    }, (error, result) => {
        if (!error) {
            console.log('results', result);
            let eventData = iface.decodeEventLog("TradeEventParams", result.data, result.topics);
